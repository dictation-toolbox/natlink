...
// NOTE: BE SURE TO UPDATE THIS FILE IN BOTH GALATOOL & GALASDK, ALONG
// WITH DEBUG & RELEASE VERSIONS OF UTIL25.LIB.

// 7/27/98 Adam: This is the SAPI 4.0 beta 1.5 speech.h.  I added
// SRGRMFMT_DRAGONNATIVE*, which MS is supposed to add soon.
