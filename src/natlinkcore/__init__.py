...
__version__="0.1"
#pylint:disable=C0114, W0401, W0611
import sys
from typing import Optional
from pathlib import Path

from natlinkcore.config import NoGoodConfigFoundException
from natlinkcore.loader import NatlinkMain
from natlinkcore.loader import run as run_loader
from natlinkcore.redirect_output import redirect as redirect_all_output_to_natlink_window
