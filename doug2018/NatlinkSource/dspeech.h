...
#undef   INTERFACE
#define  INTERFACE   IDgnSREngineNotifySink

DEFINE_GUID( IID_IDgnSREngineNotifySink,
	0xdd108001, 0x6205, 0x11cf, 0xae, 0x61,
	0x00, 0x00, 0xe8, 0xa2, 0x86, 0x47);

DECLARE_INTERFACE_ (IDgnSREngineNotifySink , IUnknown )
{
	// IUnknown members
	STDMETHOD(QueryInterface)  (THIS_ REFIID riid, LPVOID FAR* ppvObj) PURE;
	STDMETHOD_(ULONG,AddRef)   (THIS) PURE;
...
#ifdef _S_UNICODE
 #define IDgnSRGraph	IDgnSRResGraphW
